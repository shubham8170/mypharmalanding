...
export default function SecurityPage() {
  useEffect(() => {
    document.title = 'Security | CureMitra';
  }, []);
      ...
      <section className="sub-section">
        <div className="container">
          <div className="security-grid">
            ...
            >
              <Card3D className="sub-card" style={{ height: '100%', transform: 'translateZ(0)' }}>
                ...
                <p>
                  ...
                  Your patient records are shielded using standard-aligned authentication protocols.
                </p>
              </Card3D>
            </motion.div>
            ...
            >
              <Card3D className="sub-card deep security-wide" style={{ transform: 'translateZ(0)' }}>
            ...
            <motion.div
              ...
              transition={{ duration: 0.7 }}
            >
              <Card3D className="sub-card rights-card" style={{ transform: 'translateZ(0)' }}>
                <div className="feature-icon-wrap" style={{ marginBottom: 20 }}>
